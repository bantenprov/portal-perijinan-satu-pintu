...
class BantenprovPerijinanSatuPintuSeeder extends Seeder
{
    /* text color */
    ...
    protected $fileName = "BantenprovPerijinanSatuPintuSeeder.csv";
    ...
    public function __construct(){
        ...
        $this->model = new Bantenprov\PerijinanSatuPintu\Models\Bantenprov\PerijinanSatuPintu\PerijinanSatuPintu;
